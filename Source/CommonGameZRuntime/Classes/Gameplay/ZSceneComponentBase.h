...
#include "ZSceneComponentBase.generated.h"

UCLASS(Abstract, NotBlueprintable)
class COMMONGAMEZRUNTIME_API UZSceneComponentBase : public USceneComponent, public IZSharpReplicatedObject
{
	GENERATED_BODY()

public:
	UZSceneComponentBase();
